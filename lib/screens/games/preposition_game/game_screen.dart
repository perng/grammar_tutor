...
class PrepositionGameScreen extends StatefulWidget {
  final int levelIndex;
  final String routePrefix;

  const PrepositionGameScreen({
    super.key,
    required this.levelIndex,
    this.routePrefix = '/preposition-game',
  });

  @override
  State<PrepositionGameScreen> createState() => _PrepositionGameScreenState();
}

class _PrepositionGameScreenState extends State<PrepositionGameScreen> {
  List<Word> _words = [];
  ...
  Future<void> _checkAnswers() async {
    ...
    if (mounted) {
      await Provider.of<ProgressProvider>(
        context,
        listen: false,
      ).updateGameProgress('prepositions-${widget.levelIndex}', percentage);
    }
